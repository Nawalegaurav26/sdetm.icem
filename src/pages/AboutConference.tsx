...
const AboutConference = () => {
  const highlights = [
    ...
    { icon: <Star size={28} />, title: 'Second NTAI Edition', desc: 'Building on the success of the first NTAI conference with greater scope.' },
  ];
  ...
  return (
    <div className="about-conf-page">
      <div className="container">
        ...
        >
          <span className="section-subtitle">NTAI 2026</span>
        ...
        <div className="about-conf-grid">
          ...
          >
            <h2>ICSDETM 2026 — Second NTAI</h2>
            <p>
              The <strong>International Conference on Sustainable Developments in Engineering, Technology & Management (ICSDETM 2026)</strong>, also known as the <strong>Second NTAI</strong>, is a premier academic forum hosted by Indira College of Engineering and Management (ICEM), Pune on <strong>4–5 November 2026</strong>.
            </p>
            <p>
            ...
            <p>
              Following the resounding success of the inaugural NTAI edition, the second conference expands its scope to cover a broader spectrum of themes — from advanced computing and AI to sustainable mechanical engineering and management innovation.
            </p>
            <h2 style={{ marginTop: '2rem' }}>Objective</h2>
            <p>
